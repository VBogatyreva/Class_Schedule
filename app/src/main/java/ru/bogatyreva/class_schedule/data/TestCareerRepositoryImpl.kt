...
//    private val mockVacancies = emptyList<Vacancy>()   // для случая, когда вакансий нет
    ...
    val mockResumeFiles = listOf(
        UploadedResumeFile(
            fileName = "ivanov_resume.pdf",
            fileSize = "1.2 MB",
            fileType = "pdf",
            isValid = true
        ),
        UploadedResumeFile(
            fileName = "ivanov_resume.docx",
            fileSize = "0.8 MB",
            fileType = "docx",
            isValid = true
        ),
        UploadedResumeFile(
            fileName = "ivanov_resume.txt",
            fileSize = "0.3 MB",
            fileType = "txt",
            isValid = true
        ),
        UploadedResumeFile(
            fileName = "ivanov_resume.jpeg",
            fileSize = "2.1 MB",
            fileType = "jpeg",
            isValid = false
        ),
        UploadedResumeFile(
            fileName = "ivanov_resume.png",
            fileSize = "1.5 MB",
            fileType = "png",
            isValid = false
        ),
        UploadedResumeFile(
            fileName = "ivanov_resume.exe",
            fileSize = "0.5 MB",
            fileType = "exe",
            isValid = false
        ),
        UploadedResumeFile(
            fileName = "ivanov_resume.zip",
            fileSize = "3.2 MB",
            fileType = "zip",
            isValid = false
        ),
        UploadedResumeFile(
            fileName = "ivanov_resume.rtf",
            fileSize = "0.6 MB",
            fileType = "rtf",
            isValid = true
        ),
        UploadedResumeFile(
            fileName = "ivanov_resume.doc",
            fileSize = "0.9 MB",
            fileType = "doc",
            isValid = true
        )
    ...
    // Получить случайный моковый файл для тестирования формата файла резюме
    override fun getRandomMockFile(valid: Boolean?): UploadedResumeFile {
        val filtered = if (valid != null) {
            mockResumeFiles.filter { it.isValid == valid }
        } else {
            mockResumeFiles
        }
